...
**Last Updated:** 2026-09-01 (Chunks 0–9 shipped. 8 = QoL (account settings, leave/kick/rotate-code, dashboard quick-bet); 9 = Seasons (monthly derived, leaderboard toggle, Hall of Fame). Next picks from `.claude-notes/ROADMAP.md`.)
